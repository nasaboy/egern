      ...
      children: [
        ...
        { type: 'spacer' },
        {
          ...
          children: [
            ...
            { type: 'stack', direction: 'column', width: 1, height: 90, backgroundColor: '#FFFFFF20', children: [] },
            {
              ...
              children: [
                ...
                { type: 'stack', direction: 'row', alignItems: 'center', gap: 5, children: [{ type: 'image', src: 'sf-symbol:thermometer.medium', color: '#FF9500', width: 12, height: 12 }, { type: 'text', text: '舒适度  ' + comfortIndex + ' ' + comfortDesc, font: { size: 'caption1' }, textColor: '#FFFFFF99' }] },
              ],
            },
          ],
        },
        ...
        children: [
          { type: 'image', src: 'sf-symbol:' + sky.symbol, color: sky.color, width: 64, height: 64 },
          {
            ...
            children: [
              ...
              { type: 'stack', direction: 'row', alignItems: 'center', gap: 5, children: [{ type: 'image', src: 'sf-symbol:sun.and.horizon.fill', color: '#FFD60A', width: 13, height: 13 }, { type: 'text', text: '紫外线  ' + uvIndex + ' ' + uvDesc, font: { size: 'subheadline' }, textColor: '#FFFFFF99' }] },
            ],
          },
        ],
      },
